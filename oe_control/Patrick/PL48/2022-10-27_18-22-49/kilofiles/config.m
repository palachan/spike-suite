...
ops.fbinary             = fullfile(fpath, 'data.bin'); %% will be created for 'openEphys'
...
ops.Th               = [15 20 20];    % threshold for detecting spikes on template-filtered data ([6 12 12])
ops.lam              = [2 4 6];   % large means amplitudes are forced around the mean ([10 30 30])
