...
from write_nlx_headers import write_ntt_header, write_nst_header

def write_ntt(stitched, spike_times, spike_clusters, dirname, trode, fs, ampgain, acq, trodename):    
    ...
    for i in range(len(spike_times)):
        ...
        timestamp = int(spike_times[i]*1000000./fs)
        sc_number = 1
...
def write_nst(stitched, spike_times, spike_clusters, dirname, trode, fs, ampgain, acq, trodename):    
