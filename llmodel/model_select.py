    ...
    while best_model == None:
        ...
        for fold in range(10):
            ...
            for modeltype in models:
                ...
                ll_dict[modeltype].append(cdict[fold][modeltype]['llps']-cdict[fold][frozenset(('uniform',))]['llps'])
        ...
        #otherwise...
            ...
            if np.median(last_model) < np.median(median_dict[top_model]) and p < .05:
                ...
                if len(top_model) == len(variables):
                    ...
                    if np.median(ll_dict[top_model]) > 0 and p < .05:
                        best_model = top_model
                    #otherwise, the cell is unclassifiable
                    else:
                        best_model = frozenset(('uniform',))
            ...
            #otherwise, the best model is probably the last model
                ...
                #if it is, then this is the best model!
                if np.median(last_model) > 0 and p < .05:
